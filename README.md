...
compile `legged_ylo2_hw` (TODO: add a legged prefix to the package name)
...
- Imitate the `Ylo2HW` class in legged_examples/legged_ylo2/legged_ylo2_hw
  , inherit `LeggedHW` and implement the `read()` and `write()` functions of the hardware interface;
- Imitate the legged_examples/legged_ylo2/legged_unitree_description, write the xarco of the robot and generate the
